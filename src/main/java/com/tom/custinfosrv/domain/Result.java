package com.tom.custinfosrv.domain;

import com.tom.custinfosrv.common.enums.ErrorCodeEnum;
...
public class Result<T> implements Serializable {
    ...
    /**
     * 自定义返回错误结果 默认错误码为1  业务处理失败 * * @param message * @param <T> * @return
     */
    ...
    /**
     * @param code 传入对应的错误码 自动返回对应错误消息 * @param <T> * @return
     */
    ...
    /**
     * 全部自定义消息 与错误码 * * @param code * @param message * @param <T> * @return
     */
    ...
    /**
     * 使用系统默认错误码 传入错误返回结果     *     * @param result     * @param <T>     * @return
     */
    ...
    /**
     * 请求成功  默认code为0 掺入对应的返回结果     *     * @param result     * @param <T>     * @return
     */
